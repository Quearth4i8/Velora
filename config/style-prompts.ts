...
export const STYLE_PROMPTS: Record<CharacterStyle, string> = {
    ...
    [CharacterStyle.ANIME_ILLUSTRIOUS]: 'masterpiece, best quality, amazing quality, highres, absurdres, anime art, illustration, clean lineart, vibrant colors, 1girl, solo, single person, only one character, full body',
