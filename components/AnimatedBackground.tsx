...
export function AnimatedBackground() {
  ...
  // Generate consistent particles and shapes only on client
  ...
  const floatingShapes = isClient ? Array.from({ length: 5 }, (_, i) => ({
    id: i,
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      {/* Only render animated elements on client to prevent hydration mismatch */}
      {isClient && (
        <>
          {/* Gradient Orbs */}
